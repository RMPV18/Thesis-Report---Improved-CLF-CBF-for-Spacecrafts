...
\usepackage{caption}
\captionsetup[figure]{font=small, labelfont=small}%, labelfont=bf} %scriptsize or footnotesize or small or normalsize or large or Large
...
%Less time Costly Commands
  \newcommand{\uVec}{\mathbf{u}}
  \newcommand{\xVec}{\mathbf{x}}
  \newcommand{\refVec}{\mathbf{ref}} 

  %Rare
  \newcommand{\sOrderArg}{(\xVec, \mathbf{\xi})}
  \newcommand{\sOrderArgB}{(\xVec \mathcolor{gray}{, \mathbf{\xi}})}
  \newcommand{\txtref}{\(\mathbf{ref}\) }
