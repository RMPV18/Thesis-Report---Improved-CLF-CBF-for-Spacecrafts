...
With \(\eta \in \mathbb{R}_{\geq 0}\). Finally, via \Glsxtrshort{QP}, given a differentiable and locally Lipschitz continuos \(k(\xVec, \mathbf{\xi}):\mathbb{R}^n \times \mathbb{R}^p \to \mathbb{R}^m\):
